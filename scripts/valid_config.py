...
#from config_OpenAPI import ConfigurationOpenAPI ## clase Reader JSON
from simple_reader_configsOpenAPI import SimpleAutomatedOpenAPIReader ## clase Reader JSON

FM_PATH = "../variability_model/fm_OpenAPI3_0_1_v2.uvl"
...
if __name__ == '__main__':
    ...
    configuration_reader = SimpleAutomatedOpenAPIReader(path_file, "./openapi_extraction_rules.json")

    configurations = configuration_reader.transform()

    ##elements = listJson
    config = configurations[0] ## We take the first configuration generated by the JSON reader (we can iterate over all of them if we want to check all of them)
